...
String name;
    ...
    public void setWatermark(final String path, final String pdfName, String fullpathfile) {
        ...
        fullpath=fullpathfile+path;
        name=pdfName;
        Log.e("Adapter", "onClickk1: " + path);
        Log.e("Adapter removed", "onClickk12: " + pdfName);
        Log.e("Adapter removed", "onClickk13: " + fullpathfile+path);
    ...
    private String createWatermark(final String path, String pdfName) throws IOException, DocumentException {
        ...
        stamper.close();
        reader.close();
        Log.d("msg", "createWatermark33: "+pathDir + finalOutputFile);
       // openPDFView(pathDir+finalOutputFile,removeExt(finalOutputFile));

        File file = new File(pathDir+finalOutputFile);
        if (file.exists()) {
            Uri pathh = Uri.fromFile(file);
