...
import static nl.changer.polypickerdemo.Constants.MASTER_PWD_STRING;
import static nl.changer.polypickerdemo.Constants.appName;
            ...
            public void onClick(View view) {
                {
                    try {
                        ...
                        Toast.makeText(mContext, "Lock PDF Successfully", Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View view) {
                {
                    ...
                    mDialog.dismiss();
                    Toast.makeText(mContext, "Unlock PDF Successfully", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
